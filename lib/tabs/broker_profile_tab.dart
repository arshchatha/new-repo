...
class BrokerProfileTab extends StatefulWidget {
  const BrokerProfileTab({super.key});

  @override
  State<BrokerProfileTab> createState() => _BrokerProfileTabState();
}

class _BrokerProfileTabState extends State<BrokerProfileTab> {
        ...
        children: [
          Column(
            ...
            children: [
              ...
              // FMCSA Data Section
              if ((user?.loadType != null) || (user?.lanePreferences.isNotEmpty ?? false)) ...[
                const SizedBox(height: 30),
                const Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                ...
                const Divider(),
                if (user?.loadType != null) _infoRow("Load Type", user?.loadType ?? ''),
